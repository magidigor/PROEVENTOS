...
namespace ProEventos.Application
{
    public class LoteService : ILoteService
    {
        ...
        public async Task<LoteDto[]> SalveLotes(int eventoId, LoteDto[] models)
        {
            try
            {
                var lotes = await _lotePersist.GetLotesByEventoByIdAsync(eventoId);
                ...
                var loteRetorno = await _lotePersist.GetLotesByEventoByIdAsync(eventoId);
